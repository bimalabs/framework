...
import (
	...
	configs "github.com/bimalabs/framework/v4/configs"
...
// Run provides a mock function with given fields: ctx, servers
func (_m *Application) Run(ctx context.Context, servers []configs.Server) {
	_m.Called(ctx, servers)
}
